...
**Next (Chaos):**
1. **Review the `Consenting` rejections** — confirm whether the exhibits gate is over-strict on routine-but-genuine consent statements; loosen only that judgment if so. Read-only diagnosis first.
