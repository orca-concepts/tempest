...
const TheStormPage = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.body}>
        <strong>orca</strong> is language like water. Not insisting on rigid notions and seizing up into paralyzed conflict; not cloaked in unseen context and made invisible to most. <strong>orca</strong> employs category to capture meaningful context and encourage the cascading flow of conceptual development.
      </p>
